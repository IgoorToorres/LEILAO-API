import { PlaceBidUseCase } from '@/domain/auction/application/use-cases/place-bid-use-case'
...
describe('PlaceBidUseCase', () => {
  beforeEach(() => {
    ...
    sut = new PlaceBidUseCase(userRepository, auctionRepository)
  })
